...
) AND (SELECT COUNT(*) FROM dbo.Department) <= 0
BEGIN
...
ELSE
BEGIN
    PRINT 'Table Department does not exists or already has data';
END
...
) AND (SELECT COUNT(*) FROM dbo.Role) <= 0
BEGIN
...
ELSE
BEGIN
    PRINT 'Table Role does not exists or already has data';
END
...
) AND (SELECT COUNT(*) FROM dbo.FunctionManual) <= 0
BEGIN
...
ELSE
BEGIN
    PRINT 'Table FunctionManual does not exists or already has data';
END
...
ELSE
	BEGIN
		PRINT 'Table Employee does not exists or already has data';
	END
...
) AND (SELECT COUNT(*) FROM dbo.SaCategory) <= 0
BEGIN
...
ELSE
	BEGIN
		PRINT 'Table SaCategory does not exists or already has data';
	END
...
) AND (SELECT COUNT(*) FROM dbo.SaType) <= 0
BEGIN
...
ELSE
BEGIN
    PRINT 'Table SaType does not exists or already has data';
END
...
) AND (SELECT COUNT(*) FROM dbo.Sickness) <= 0
BEGIN
...
ELSE
BEGIN
    PRINT 'Table Sickness does not exists or already has data';
END
...
) AND (SELECT COUNT(*) FROM dbo.Accident) <= 0
BEGIN
...
ELSE
BEGIN
    PRINT 'Table Accident does not exists or already has data';
END
...
) AND (SELECT COUNT(*) FROM dbo.PpeClassification) <= 0
BEGIN
...
ELSE
BEGIN
    PRINT 'Table PpeClassification does not exists into the database';
END
...
) AND (SELECT COUNT(*) FROM dbo.Ppe) <= 0
BEGIN
...
ELSE
BEGIN
    PRINT 'Table Ppe does not exists or already has data';
END
...
) AND (SELECT COUNT(*) FROM dbo.ExistingPpe) <= 0
BEGIN
...
ELSE
BEGIN
    PRINT 'Table ExistingPpe does not exists or already has data';
END
...
) AND (SELECT COUNT(*) FROM dbo.ExistingPpeAssigned) <= 0
BEGIN
...
ELSE
BEGIN
    PRINT 'Table ExistingPpeAssigned does not exists or already has data';
END
...
) AND (SELECT COUNT(*) FROM dbo.WorkItemClassification) <= 0
BEGIN
...
ELSE
BEGIN
    PRINT 'Table WorkItemClassification does not exists or already has data';
END
...
) AND (SELECT COUNT(*) FROM dbo.WorkItem) <= 0
BEGIN
...
ELSE
BEGIN
    PRINT 'Table WorkItem does not exists or already has data';
END
...
) AND (SELECT COUNT(*) FROM dbo.ExistingWorkItem) <= 0
BEGIN
...
ELSE
BEGIN
    PRINT 'Table ExistingWorkItem does not exists or already has data';
END
